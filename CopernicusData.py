...
username_cmems = 'lcastrilloacua'
password_cmems = 'Lluis123#'
...
dict_id = {"Temperature_Dailymean": \
           ["-v analysed_sst", "-d METOFFICE-GLO-SST-L4-REP-OBS-SST", \
            "-s SST_GLO_SST_L4_REP_OBSERVATIONS_010_011-TDS", "-m http://my.cmems-du.eu/motu-web/Motu"]
          }
